                    ...
                    >
                        <div className={clsx(kcClsx("kcFormGroupClass"), "no-bottom-margin")}>
                            ...
                            {messagesPerField.existsError("password") && (
                                <div id="input-error-password" className={kcClsx("kcInputErrorMessageClass")} aria-live="polite">
                                    {/* Можно добавить иконку AlertCircle из lucide-react */}
                                    <span className="flex items-center gap-1">{kcSanitize(messagesPerField.get("password"))}</span>
                                </div>
                            )}
